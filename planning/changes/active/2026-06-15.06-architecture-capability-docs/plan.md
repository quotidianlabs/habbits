...
Defined by: [<bundle-slug>](../planning/changes/archive/<dir>/design.md)<, ...>
```
...
- [ ] **Step 1: Read the sources**
  ...
  Read for intent: `planning/changes/archive/2026-06-13.01-foundation/design.md`,
  `planning/changes/archive/2026-06-15.01-architecture-refactor/design.md`,
  `planning/changes/archive/2026-06-14.03-reorder-habits/design.md`.
...
- [ ] **Step 1: Read the sources**
  ...
  Intent: `planning/changes/archive/2026-06-13.02-heatmap-retroactive-editing/design.md`,
  `planning/changes/archive/2026-06-13.01-foundation/design.md`.
...
- [ ] **Step 1: Read the sources**
  ...
  Intent: `planning/changes/archive/2026-06-14.02-reminders/design.md`.
...
- [ ] **Step 1: Read the sources**
  ...
  Intent: `planning/changes/archive/2026-06-14.01-export-import/design.md`.
...
- [ ] **Step 1: Read the sources**
  ...
  Intent: `planning/changes/archive/2026-06-14.04-russian-language/design.md`.
...
- [ ] **Step 1: Read the sources**
  ...
  `lib/ui/settings/`.
  Intent: `planning/changes/archive/2026-06-13.03-usability-v2/design.md`,
  `planning/changes/archive/2026-06-15.02-app-icon-branding/design.md`.
...
- [ ] **Move the bundle to archived** once merged (per convention): set
  ...
  `planning/changes/archive/`, and move its Index line from **Active** to
