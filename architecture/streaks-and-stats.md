...
Defined by: [2026-06-13.01-foundation](../planning/changes/2026-06-13.01-foundation.md), [2026-06-13.02-heatmap-retroactive-editing](../planning/changes/2026-06-13.02-heatmap-retroactive-editing.md), [2026-06-17.01-completion-pct-first-check](../planning/changes/2026-06-17.01-completion-pct-first-check.md). Scalar composition moved into `HabitSummary.from` and all rendered views switched to `currentDayProvider` in [2026-06-24.01-habit-summary-factory](../planning/changes/2026-06-24.01-habit-summary-factory.md). The home check-off (`toggleToday`) switched from the wall clock to `currentDayProvider` in [2026-06-24.02-toggle-today-anchor](../planning/changes/2026-06-24.02-toggle-today-anchor.md).
